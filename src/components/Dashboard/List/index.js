...
function List({ coin, delay }) {
  ...
  return (
    <a href={`/coin/${coin.id}`}>
      ...
      >
        <Tooltip title="Imagem Moeda">
          <td className="td-img">
            <img src={coin.image} className="coin-image coin-image-td" />
          </td>
        </Tooltip>
        <Tooltip title="Info Moeda" placement="bottom-start">
        ...
        <Tooltip
          title="Porcentagem do preço da moeda em 24 horas"
        ...
        <Tooltip title="Preço da moeda em USD" placement="bottom-end">
          {coin.price_change_percentage_24h >= 0 ? (
        ...
        <Tooltip title="Volume total da moeda" placement="bottom-end">
          <td className="coin-name td-totalVolume">
            {coin.total_volume.toLocaleString()}
          </td>
        </Tooltip>
        <Tooltip title="Market Capital da moeda" placement="bottom-end">
